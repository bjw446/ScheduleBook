...
public interface ForceLogoutRetryRepository extends JpaRepository<ForceLogoutRetry, Long> {
    ...
    @Query("UPDATE ForceLogoutRetry f SET f.forceLogoutRetryStatus = " +
            ...
            "f.reason = NULL, f.nextRetryAt = NULL, f.claimToken = NULL, " +
            "f.processingAt = NULL, f.updatedAt = CURRENT_TIMESTAMP " +
    ...
    @Query("UPDATE ForceLogoutRetry f SET f.forceLogoutRetryStatus = " +
            ...
            "f.retryCount = f.retryCount + 1, f.reason = :reason, " +
            "f.nextRetryAt = :nextRetryAt, f.processingAt = NULL, " +
    ...
    @Query("UPDATE ForceLogoutRetry f SET f.forceLogoutRetryStatus = " +
            ...
            "f.claimToken = :claimToken, f.reason = NULL, f.nextRetryAt = NULL, " +
            "f.processingAt = CURRENT_TIMESTAMP, f.updatedAt = CURRENT_TIMESTAMP " +
    ...
    @Query("UPDATE ForceLogoutRetry f SET f.forceLogoutRetryStatus = " +
            ...
            "f.claimToken = NULL, f.updatedAt = CURRENT_TIMESTAMP, f.processingAt = NULL " +
