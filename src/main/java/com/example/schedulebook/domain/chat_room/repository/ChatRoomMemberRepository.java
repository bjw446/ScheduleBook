package com.example.schedulebook.domain.chat_room.repository;
...
public interface ChatRoomMemberRepository extends JpaRepository<ChatRoomMember, Long> {
    ...
    @Query("SELECT crm.chatRoom.id as roomId, crm.chatRoom.name as roomName, " +
            "CASE WHEN crm.chatRoom.chatRoomType = com.example.schedulebook.domain.chat_message.enums.ChatRoomType.DIRECT " +
